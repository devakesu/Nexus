...
/// Bottom sheet for changing age, gated to once every 365 days.
///
...
List<Widget> _buildIneligibleContent(
  ...
  return [
    ...
    Text(
      "You've already used this year's change. You can change your age "
      'again on $formattedDate.',
...
List<Widget> _buildIntroContent({
  ...
  return [
    Text(
      'To protect against impersonation and abuse, age can only be '
      'changed once every 365 days - make this one count.',
      style: TextStyle(color: Colors.black.withValues(alpha: 0.6), fontSize: 13),
    ),
...
List<Widget> _buildConfirmContent({
  ...
  return [
    Text(
      ...
      'You can only do this once every 365 days, so make sure this is '
