String getEmojiForTag(String tag) {
  ...
  switch (cleanTag) {
    ...
    case 'Genderqueer': return '💜';
    case 'Genderfluid': return '💧';
    case 'Agender': return '⚪';
    case 'Transgender Man': return '🏳️‍⚧️';
    case 'Transgender Woman': return '🏳️‍⚧️';
    case 'Gender Non-Conforming': return '🦄';
    case 'Pangender': return '🌀';
    case 'Androgynous': return '👤';
    case 'Neutrois': return '⚪';
    case 'Third Gender': return '🔱';
    case 'Intersex': return '🟡';
    case 'Bigender': return '👥';
    case 'Two-Spirit': return '🪶';
    case 'Demiboy': return '👦';
    case 'Demigirl': return '👧';
    case 'Queer': return '🌈';
    ...
    case 'Greysexual': return '🩶';
    case 'Polysexual': return '💛';
    case 'Omnisexual': return '🪐';
    case 'Fluid': return '🌊';
    case 'Skoliosexual': return '🌀';
    case 'Demisexual': return '💜';

    // Languages
    case 'English': return '🇬🇧';
    case 'Spanish': return '🇪🇸';
    case 'Mandarin Chinese': return '🇨🇳';
    case 'Hindi': return '🇮🇳';
    case 'Arabic': return '🇸🇦';
    ...
    // Causes Supported
    case 'Climate Action': return '🌲';
    case 'Tech Ethics': return '⚖️';
    case 'Mental Health': return '🧠';
    case 'LGBTQ+ Rights': return '🌈';
    case 'Education Access': return '📚';
    case 'Animal Protection': return '🐾';
    case 'Disaster Relief': return '🚨';
    case 'Poverty Alleviation': return '🤝';
    case 'Gender Equality': return '⚧️';
    case 'Scientific Research': return '🔬';
    case 'Mental Health Advocacy': return '💬';
    case 'Human Rights': return '✊';
    case 'Clean Water & Sanitation': return '💧';
    case 'Renewable Energy': return '⚡';
    case 'Economic Development': return '📈';
    case 'Arts & Culture Preservation': return '🏛️';
