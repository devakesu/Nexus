                    ...
                    child: widget.handshakes.isEmpty
                        ...
                        : GridView.builder(
                            ...
                            itemBuilder: (ctx, index) {
                              final item = widget.handshakes[index] as Map<String, dynamic>;
...
class ConnectionsOverlay extends StatefulWidget {
  ...
  final Future<bool> Function(String targetId, String action, String accessToken, {String? reason, String? reasonDetail}) onRecordConnectionAction;
...
class _ConnectionsOverlayState extends State<ConnectionsOverlay> {
  ...
  void removeConnection(String userId) {
    setState(() {
      widget.connections.removeWhere((dynamic c) => (c as Map<String, dynamic>)['matched_user_id'] == userId);
    });
  }
