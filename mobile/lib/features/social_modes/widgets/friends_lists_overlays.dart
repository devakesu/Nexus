...
import 'package:nexus/core/utils/responsive.dart';
                ...
                : LayoutBuilder(
                    builder: (context, constraints) => GridView.builder(
                      ...
                      itemBuilder: (ctx, index) {
                        final item =
                            widget.waves[index] as Map<String, dynamic>;
  ...
  void removeFriend(String userId) {
    setState(() {
      widget.friends.removeWhere(
        (dynamic f) => (f as Map<String, dynamic>)['matched_user_id'] == userId,
      );
    });
  }
            ...
            child: widget.friends.isEmpty
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final userId = friend['matched_user_id'] as String? ?? '';
                      final name = friend['name'] as String? ?? 'Unknown';
                      final age = friend['age'];
                      final profilePic = friend['profile_pic'] as String?;
