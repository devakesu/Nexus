      ...
      theme: ThemeData(
        ...
        textTheme: GoogleFonts.interTextTheme(
          ThemeData.dark().textTheme.copyWith(
            displayLarge: const TextStyle(color: Color(0xFFE2D9F3)),
            displayMedium: const TextStyle(color: Color(0xFFE2D9F3)),
            displaySmall: const TextStyle(color: Color(0xFFE2D9F3)),
            headlineLarge: const TextStyle(color: Color(0xFFE2D9F3)),
            headlineMedium: const TextStyle(color: Color(0xFFE2D9F3)),
            headlineSmall: const TextStyle(color: Color(0xFFE2D9F3)),
            titleLarge: const TextStyle(color: Color(0xFFE2D9F3)),
            titleMedium: const TextStyle(color: Color(0xFFE2D9F3)),
            titleSmall: const TextStyle(color: Color(0xFFE2D9F3)),
          ),
        ),
        useMaterial3: true,
      ),
